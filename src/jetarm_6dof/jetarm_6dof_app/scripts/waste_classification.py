...
class WasteClassificationNode:
    def __init__(self, node_name, log_level=rospy.INFO):
        ...
        #weights = '/home/hiwonder/weights/garbage_classification/garbage640_2023_09_22.engine'
        #lib = '/home/hiwonder/weights/garbage_classification/libmyplugins640_2023_09_22.so'
    ...
    def enter_srv_callback(self, req):
        ...
        with self.lock:
            ...
            self.moving_step = 0
            self.enable_transport = False
            threading.Thread(target=actions.go_home, args=(self.servos_pub,)).start()
    ...
    def start_moving(self, pose_t, pose_R):
        ...
        if self.enable_voice:
            play("/home/hiwonder/jetarm/src/jetarm_6dof/jetarm_6dof_app/waste_pcm/" + self.target[-1] + ".pcm")
        print(pose_t, pose_R)
        self.moving_step = 1
        goal = MoveGoal()
