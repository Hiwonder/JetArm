# 此文件时 jethexa 的一部分(this file is part of Jethexa)
# /face_detect/utils.py 进行人脸识别时用到的一些小工具(some small utilities used in face recognition)
# !!!!!!! 如果修改了本文件， 需要使用在～/jethexa 目录下执行(if you modify this file, you need to execute it in the ~/jethexa directory)
# !!!!!!! 命令 colcon build --packages-select face_detect"(command colcon build --packages-select face_detect")
# !!!!!!! 重新构建安装本ros包， 使得本文件生效(rebuild and install this ROS package to make this file effective)
