...
(cl:defmethod corners-val ((m <AprilTagDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader apriltag_ros-msg:corners-val is deprecated.  Use apriltag_ros-msg:corners instead.")
  (corners m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AprilTagDetection>)))
  ...
  "41214849d7fbb1df8896b60cfa49b854")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AprilTagDetection)))
  "Returns md5sum for a message object of type 'AprilTagDetection"
  "41214849d7fbb1df8896b60cfa49b854")
