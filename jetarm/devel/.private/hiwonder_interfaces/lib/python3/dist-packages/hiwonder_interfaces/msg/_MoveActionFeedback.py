...
"""autogenerated by genpy from hiwonder_interfaces/MoveActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "fac51b21f75d9d7310045437b6489914"
  _type = "hiwonder_interfaces/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hiwonder_interfaces/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = hiwonder_interfaces.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hiwonder_interfaces.msg.MoveFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.percent,) = _get_struct_d().unpack(str[start:end])
      return self
