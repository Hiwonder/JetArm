...
class AprilTagDetection(genpy.Message):
  _md5sum = "41214849d7fbb1df8896b60cfa49b854"
...
float64 w
"""
  __slots__ = ['id','size','corners','pose']
  _slot_types = ['int32[]','float64[]','geometry_msgs/Point[4]','geometry_msgs/PoseWithCovarianceStamped']
