...
"""autogenerated by genpy from hiwonder_interfaces/MultiRawIdPosDur.msg. Do not edit."""
import codecs
import sys
...
class MultiRawIdPosDur(genpy.Message):
  ...
  _type = "hiwonder_interfaces/MultiRawIdPosDur"
...
"""
  ...
  _slot_types = ['hiwonder_interfaces/RawIdPosDur[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hiwonder_interfaces.msg.RawIdPosDur()
        _x = val1
        start = end
        end += 5
