...
if("TRUE" STREQUAL "TRUE")
  set(lab_config_SOURCE_PREFIX /home/ubuntu/jetarm/src/lab_config)
  set(lab_config_DEVEL_PREFIX /home/ubuntu/jetarm/devel/.private/lab_config)
  ...
  set(lab_config_INSTALL_PREFIX /home/ubuntu/jetarm/install)
...
if(NOT "/home/ubuntu/jetarm/devel/.private/lab_config/include " STREQUAL " ")
  set(lab_config_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/jetarm/devel/.private/lab_config/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/jetarm/src/lab_config/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/jetarm/devel/.private/lab_config/lib;/home/ubuntu/jetarm/devel/lib;/opt/ros/noetic/lib)
