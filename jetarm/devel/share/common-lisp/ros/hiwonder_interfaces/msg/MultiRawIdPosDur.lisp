...
(cl:defclass <MultiRawIdPosDur> (roslisp-msg-protocol:ros-message)
  ((id_pos_dur_list
    ...
    :type (cl:vector hiwonder_interfaces-msg:RawIdPosDur)
   :initform (cl:make-array 0 :element-type 'hiwonder_interfaces-msg:RawIdPosDur :initial-element (cl:make-instance 'hiwonder_interfaces-msg:RawIdPosDur))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MultiRawIdPosDur>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiRawIdPosDur)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hiwonder_interfaces-msg:<MultiRawIdPosDur> is deprecated: use hiwonder_interfaces-msg:MultiRawIdPosDur instead.")))

(cl:ensure-generic-function 'id_pos_dur_list-val :lambda-list '(m))
(cl:defmethod id_pos_dur_list-val ((m <MultiRawIdPosDur>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hiwonder_interfaces-msg:id_pos_dur_list-val is deprecated.  Use hiwonder_interfaces-msg:id_pos_dur_list instead.")
  (id_pos_dur_list m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MultiRawIdPosDur>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'id_pos_dur_list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hiwonder_interfaces-msg:RawIdPosDur))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MultiRawIdPosDur>)))
  ...
  "hiwonder_interfaces/MultiRawIdPosDur")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MultiRawIdPosDur)))
  "Returns string type for a message object of type 'MultiRawIdPosDur"
  "hiwonder_interfaces/MultiRawIdPosDur")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MultiRawIdPosDur>)))
  ...
  (cl:format cl:nil "RawIdPosDur[] id_pos_dur_list~%================================================================================~%MSG: hiwonder_interfaces/RawIdPosDur~%uint8 id~%uint16 position~%uint16 duration~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MultiRawIdPosDur)))
  "Returns full string definition for message of type 'MultiRawIdPosDur"
  (cl:format cl:nil "RawIdPosDur[] id_pos_dur_list~%================================================================================~%MSG: hiwonder_interfaces/RawIdPosDur~%uint8 id~%uint16 position~%uint16 duration~%~%~%"))
