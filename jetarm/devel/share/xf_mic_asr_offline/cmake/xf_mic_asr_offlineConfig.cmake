...
if("TRUE" STREQUAL "TRUE")
  set(xf_mic_asr_offline_SOURCE_PREFIX /home/ubuntu/jetarm/src/xf_mic_asr_offline)
  set(xf_mic_asr_offline_DEVEL_PREFIX /home/ubuntu/jetarm/devel/.private/xf_mic_asr_offline)
  ...
  set(xf_mic_asr_offline_INSTALL_PREFIX /home/ubuntu/jetarm/install)
...
if(NOT "/home/ubuntu/jetarm/devel/.private/xf_mic_asr_offline/include " STREQUAL " ")
  set(xf_mic_asr_offline_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/jetarm/devel/.private/xf_mic_asr_offline/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xf_mic_asr_offline' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/jetarm/src/xf_mic_asr_offline/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/jetarm/devel/.private/xf_mic_asr_offline/lib;/home/ubuntu/jetarm/devel/lib;/opt/ros/noetic/lib)
