...
class TrtMtcnn(object):
    ...
    def __init__(self):
        self.pnet = TrtPNet('/home/ubuntu/third_parts/tensorrt_demos/mtcnn/det1.engine')
        self.rnet = TrtRNet('/home/ubuntu/third_parts/tensorrt_demos/mtcnn/det2.engine')
        self.onet = TrtONet('/home/ubuntu/third_parts/tensorrt_demos/mtcnn/det3.engine')
