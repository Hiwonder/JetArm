...
OLD_BUTTON_MAP = 'A', 'B', '', 'X', 'Y', '', 'l1', 'r1', 'l2', 'r2', 'select', 'start', '', 'l3', 'r3', 'hat_xu', 'hat_xd', 'hat_yl', 'hat_yr', 'laxis_l', 'laxis_r', 'laxis_u', 'laxis_d', 'raxis_l', 'raxis_r', 'raxis_u', 'raxis_d'

NEW_AXES_MAP = 'ly', 'lx', 'ry', 'rx', 'hat_x', 'hat_y'
NEW_BUTTON_MAP = 'Y', 'B', 'A', 'X', 'l1', 'r1', 'l2', 'r2', 'select', 'start','', '', 'mode',  'hat_xu', 'hat_xd','hat_yl', 'hat_yr'
